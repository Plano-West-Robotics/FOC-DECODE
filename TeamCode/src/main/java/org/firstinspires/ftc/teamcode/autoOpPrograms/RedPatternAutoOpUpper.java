...
public class RedPatternAutoOpUpper extends OpMode {
    ...
    private final double TOP_START_ANGLE = Math.toRadians(216);
    private final double BOT_START_ANGLE = Math.toRadians(90);
    private final double COLLECTION_ANGLE = Math.toRadians(180);
    private final double TOP_LAUNCH_ANGLE = Math.toRadians(49);
    private final double BOT_LAUNCH_ANGLE = Math.toRadians(63.5);
    private final double SCAN_ANGLE = Math.toRadians(90);
    private final double END_ANGLE = Math.toRadians(90);

    private final Pose TOP_START_POSE = new Pose(123, 123);
    private final Pose BOT_START_POSE = new Pose(88, 8);
    ...
    private final Pose TOP_SCORING_POSE = new Pose(85,85);
    private final Pose BOT_SCORING_POSE = new Pose(82,12);

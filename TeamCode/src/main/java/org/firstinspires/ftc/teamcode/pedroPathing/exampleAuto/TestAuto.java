...
import org.firstinspires.ftc.teamcode.pedroPathing.paths.GeneratedPath;
...
public class TestAuto extends OpMode {
            ...
            case 1:
                ...
                */
                ...
                if(!follower.isBusy()) {
                    ...
                    follower.followPath(genTest.getPath(),true);
                    setPathState(2);
                }
                break;
            case 2:
    ...
    public void init() {
        ...
        genTest = new GeneratedPath(follower);
        buildPaths();
    }
